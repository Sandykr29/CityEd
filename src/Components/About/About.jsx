  ...
  return (
    <div className='about'>
        ...
        <div className="about-right">
            ...
            <p>Whether you aspire to become a teacher, adminstrator, counselor, or ecucational leader, our diverse range of programs offers the perfect path way to achieve your goals and unlock your full potential in shaping the future of education.</p>
        </div>
    </div>
  )
}
